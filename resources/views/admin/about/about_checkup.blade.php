...
<style type="text/css">
    ...
    <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>About Medical Checkups</span></a>
            </li>
         </ul>
      </div>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">About Medical Checkups</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <!-- <button class="btn1"><a href="{{url('admin/add_about_checkup_data')}}/0" style="color:white;">ADD</a></button> -->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
                 ...
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->description}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_about_checkup_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_about_checkup/'+id,
                                            type:'GET',
                                            dataType: "json",
