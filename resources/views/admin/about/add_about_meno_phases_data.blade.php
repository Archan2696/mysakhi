...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add About Phases</span></a>
               @else
               <a href=""><span>Update About Phases</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add About Phases</h4>
          @else
            <h4 class="mb-4">Update About Phases</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_about_meno_phases_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
