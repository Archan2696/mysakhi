...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Subscription Data</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Subscription Data</h4>
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{ route('export-subscription') }}" style="color:white;">Export Data</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
                ...
                @foreach($newsletter as $key=>$ad)
                    <tr class="change_visibility_{{$ad->id}}">
                       ...
                       <td>{{$ad->date}}</td>
                        ...
                        <td>
                          <!-- <a class="icon__1" href="{{url('admin/add_subscription_data_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a> -->
