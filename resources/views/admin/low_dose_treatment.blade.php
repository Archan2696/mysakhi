...
@section('content')
        ...
        <div class="head-banner">
             <ul class="breadcrumb">
                ...
                <li>
                   <a href=""><span>Low Dose Treatment Treatment</span></a>
                </li>
             </ul>
        </div>
    ...
    <style type="text/css">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Low Dose Treatment Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($low_dose_treatment_description as $id)
                 <tr>
                    <th>Title</th>
                </tr>
                <tr>
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_low_dose_treatment_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_low_dose_treatment/'+id,
                                            type:'GET',
                                            dataType: "json",
