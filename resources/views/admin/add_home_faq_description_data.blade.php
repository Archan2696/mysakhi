...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Home FAQ Description</span></a>
               @else
               <a href=""><span>Update Home FAQ Description</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Home FAQ Description</h4>
          @else
            <h4 class="mb-4">Update Home FAQ Description</h4>
            @endif
         </div>
         <form action="{{url('admin/store_update_home_faq_description_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
         <div class="detail table-responsive">
            <div class="details_main">
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/home_faq')}}">Back to Home?</a>
               </div>
            </div>
         </div>
