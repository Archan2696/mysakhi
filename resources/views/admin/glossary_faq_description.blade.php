...
<style type="text/css">
    ...
    <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Glossary & FAQ Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($glossary_faq_description as $id)
                ...
                <tr>
                    <th class="text">{{$id->faq_title}}</th>
                </tr>

                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/add_glossary_faq_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
