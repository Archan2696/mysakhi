...
<style type="text/css">
    ...
    <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Healthy Hormonal, and Psychosocial</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Healthy Hormonal, and Psychosocial Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($healthy_intimacy_hormonal_description as $id)

                <tr>
                    <th>Image</th>
                </tr>
                <tr>
                    <th class="text"><img src="/uploads/{{$id->image}}" width="200" height="200"></th>
                </tr>
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_healthy_intimacy_hormonal_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Healthy Hormonal, and Psychosocial</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_healthy_intimacy_hormonal_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($healthy_intimacy_hormonal as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{ $ad->description }}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_healthy_intimacy_hormonal_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_healthy_intimacy_hormonal/'+id,
                                            type:'GET',
                                            dataType: "json",
