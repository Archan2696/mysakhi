...
<style type="text/css">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Latest Complete Work Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Latest Complete Work Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($latest_work_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_latest_work_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Latest Complete Work Details</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_latest_work_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
                 ...
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                        ...
                        <td>
                         ...
                         @if($id->latest_work_id==$ad->id)
                          <img src="{{url('/uploads')}}/{{$id->image}}" width="100" height="100">
                          @endif
                          @endforeach
                        </td>
                       <td>{{$ad->title}}</td>
                        <td>
                          <a class="icon__1" href="{{url('admin/add_latest_work_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_latest_work/'+id,
                                            type:'GET',
                                            dataType: "json",
