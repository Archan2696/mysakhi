...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Home Choose Us</span></a>
               @else
               <a href=""><span>Update Home Choose Us</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Home Choose Us</h4>
          @else
            <h4 class="mb-4">Update Home Choose Us</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_home_choose_us_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
