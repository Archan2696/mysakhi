...
<style type="text/css">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span> Essential CTA Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Essential CTA Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($essential_cta_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/add_essential_cta_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
