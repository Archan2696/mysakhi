...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Lifestyle Changes Description</span></a>
               @else
               <a href=""><span>Update Lifestyle Changes Description</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Lifestyle Changes Description</h4>
          @else
            <h4 class="mb-4">Update Lifestyle Changes Description</h4>
            @endif
         </div>
         <form action="{{url('admin/store_update_lifestyle_changes_description_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
            ...
            <div class="details_inner row">
              ...
              <div class="details_inner">
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/lifestyle_changes')}}">Back to Home?</a>
               </div>
            </div>
         </div>
