...
<style type="text/css">
    ...
    <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>About Healthy Intimacy</span></a>
            </li>
         </ul>
      </div>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">About Healthy Intimacy</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <!-- <button class="btn1"><a href="{{url('admin/add_healthy_intimacy_about_data')}}/0" style="color:white;">ADD</a></button> -->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
               ...
               <thead>
                  <tr>
                    <!-- <th><input type="checkbox" name="" id="chkcheckAll"/></th> -->
                     ...
                     <th style="width:15%;">Description 1</th>
                     <th>Action</th>
                  </tr>
               </thead>

               @foreach($healthy_intimacy_about as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                        ...
                        <td>{{$ad->highlight_title}}</td>
                        <td>{{$ad->title}}</td>
                        <td>{{$ad->highlight_text}}</td>
                        <td>{{$ad->description}}</td>
                        <td>{{$ad->description1}}</td>

                        <td>
                          <a class="icon__1" href="{{url('admin/add_healthy_intimacy_about_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_healthy_intimacy_about/'+id,
                                            type:'GET',
                                            dataType: "json",
