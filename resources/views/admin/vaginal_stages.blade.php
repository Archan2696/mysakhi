...
@section('content')
        ...
        <div class="head-banner">
             <ul class="breadcrumb">
                ...
                <li>
                   <a href=""><span>Vaginal Stages</span></a>
                </li>
             </ul>
        </div>
    ...
    <style type="text/css">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="btn1-main">
            ...
            <button class="btn1 active act_btn"><a href="{{url('/admin/vaginal_symptoms')}}" >Vaginal Symptoms</a></button>
            <button class="btn1 active "><a href="{{url('/admin/vaginal_stages')}}" style="color:white">Vaginal Stages</a></button>
         </div>
      </div>

    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Vaginal Stages</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_vaginal_stages_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($vaginal_stages as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->description}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_vaginal_stages_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_vaginal_stages/'+id,
                                            type:'GET',
                                            dataType: "json",
