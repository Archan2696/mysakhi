...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Testimonial Description</span></a>
               @else
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Testimonial Description</h4>
          @else
            <h4 class="mb-4">Update Testimonial Description</h4>
            @endif
         </div>
         <form action="{{url('admin/store_update_testimonial_heading_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
         	@csrf
