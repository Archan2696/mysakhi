...
@section('content')
        ...
        <div class="head-banner">
             <ul class="breadcrumb">
                ...
                <li>
                   <a href=""><span>Menopause And Relationship</span></a>
                </li>
             </ul>
        </div>
    ...
    <style type="text/css">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Menopause And Relationship Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($menopause_relationship_description as $id)
                <tr>
                    <th>Title1</th>
                </tr>
                <tr>
                ...
                <tr>
                    <th class="text">{{$id->highlight_description}}</th>
                </tr>
                
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_menopause_relationship_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Menopause And Relationship</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_menopause_relationship_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($menopause_relationship as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>
                        ...
                        @foreach($menopause_relationship_list as $pml)
                        @if($pml->list_id==$ad->id)
                        <p>{{$pml->list_title}}</p>
                        @endif
                        @endforeach
                       ...
                       <td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_menopause_relationship_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_menopause_relationship/'+id,
                                            type:'GET',
                                            dataType: "json",
