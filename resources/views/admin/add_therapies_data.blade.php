...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Therapies Heading</span></a>
               @else
               <a href=""><span>Update Therapies Heading</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Therapies Heading</h4>
          @else
            <h4 class="mb-4">Update Therapies Heading</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_therapies_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
            @csrf
         <div class="detail table-responsive">
            <div class="details_main">
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/therapies')}}">Back to Home?</a>
               </div>
            </div>
         </div>
