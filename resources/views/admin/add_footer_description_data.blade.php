         ...
         <div class="detail table-responsive">
            <div class="details_main">
               ...
               <div class="details_inner">
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                             <textarea type="text" name="disclaimer_description">{{$disclaimer_description}}</textarea>   
                              @if($errors->has('disclaimer_description')) <p class="error_mes">{{ $errors->first('disclaimer_description') }}</p> @endif
                        </div>
                     </div>   
                  </div>
               </div>    
                ...
                <div class="details_inner">
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                             <textarea type="text" name="copyright">{{$copyright}}</textarea>   
                              @if($errors->has('copyright')) <p class="error_mes">{{ $errors->first('copyright') }}</p> @endif
                        </div>
                     </div>   
                  </div>
               </div>    
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/footer_description')}}">Back to Home?</a>
               </div>
            </div>
         </div>
