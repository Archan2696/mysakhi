...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Vaginal Treatment</span></a>
               @else
               <a href=""><span>Update Vaginal Treatment</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Vaginal Treatment</h4>
          @else
            <h4 class="mb-4">Update Vaginal Treatment</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_vaginal_treatment_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
            @csrf
           ...
           <div class="details_inner">
                  <div class="part">
                     <div class="row">
                        ...
                        <div class="col-lg-10 data">
                             <textarea type="text" name="benefit_description" id="summernote">{{$benefit_description}}</textarea>   
                              @if($errors->has('benefit_description')) <p class="error_mes">{{ $errors->first('benefit_description') }}</p> @endif
                        </div>
                     </div>   
                  </div>
               </div>  
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/vaginal_treatment')}}">Back to Home?</a>
               </div>
            </div>
         </div>
