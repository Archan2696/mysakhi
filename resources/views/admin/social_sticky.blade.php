...
<style type="text/css">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Social Media Links</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($social_sticky as $id)
                <tr>
                    <th>Facebook Url</th>
                </tr>
                <tr>
                    <th class="text">{{$id->facebook_url}}</th>
                </tr>
                ...
                <tr>
                    <th class="text">{{$id->twitter_url}}</th>
                </tr>

                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/add_social_sticky_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
