...
@section('content')
        ...
        <div class="head-banner">
             <ul class="breadcrumb">
                ...
                <li>
                   <a href=""><span>Psychosocial About</span></a>
                </li>
             </ul>
        </div>
    ...
    <style type="text/css">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="btn1-main">
            <button class="btn1 active "><a href="{{url('/admin/psychosocial_about')}}" style="color:white">Psychosocial About</a></button>
            <button class="btn1 active act_btn"><a href="{{url('/admin/psychosocial_symptoms')}}" >Psychosocial Symptoms</a></button>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Psychosocial About</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <!--<button class="btn1"><a href="{{url('admin/add_psychosocial_about_data')}}/0" style="color:white;">ADD</a></button>-->
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($psychosocial_about as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->description}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_psychosocial_about_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_psychosocial_about/'+id,
                                            type:'GET',
                                            dataType: "json",
