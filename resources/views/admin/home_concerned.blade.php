...
@section('content')
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Home Concerned Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Home Concerned Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($home_concerned_description as $id)

                <tr>
                    <th>Image</th>
                </tr>
                <tr>
                    <th class="text"> <img src="/uploads/{{$id->image}}" width="150" height="150"> </th>
                </tr>
                ...
                <tr>
                    <th class="text">{{$id->sub_title1}}</th>
                </tr>
                <tr>
                    <th>Sub Title2</th>
                </tr>
                <tr>
                    <th class="text">{{$id->sub_title2}}</th>
                </tr>                

                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_home_concerned_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Home Concerned Details</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_home_concerned_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($home_concerned as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->name}}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_home_concerned_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_home_concerned/'+id,
                                            type:'GET',
                                            dataType: "json",
