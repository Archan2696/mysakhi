...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Psychosocial Symptoms</span></a>
               @else
               <a href=""><span>Update Psychosocial Symptoms</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Psychosocial Symptoms</h4>
          @else
            <h4 class="mb-4">Update Psychosocial Symptoms</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_psychosocial_symptoms_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
            @csrf
         <div class="detail table-responsive">
            <div class="details_main">
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/psychosocial_symptoms')}}">Back to Home?</a>
               </div>
            </div>
         </div>
