...
<style type="text/css">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Essential Test Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Essential Test Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($essential_test_description as $id)
                ...
                <tr>
                    <th class="text">
                        <div class="row">
                            <div class="col-2">
                                <img src="/uploads/{{$id->image}}" width="150" height="100">
                            </div>
                        </div>
                    </th>
                </tr>
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_essential_test_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Essential Test Details</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_essential_test_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped">
               ...
               @foreach($essential_test as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{!!$ad->description!!}</td>
                        ...
                        <td>
                          <a class="icon__1" href="{{url('admin/add_essential_test_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_essential_test/'+id,
                                            type:'GET',
                                            dataType: "json",
