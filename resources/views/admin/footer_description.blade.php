...
<style type="text/css">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Footer Details</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                <tr>
                    <th class="text">{{$id->disclaimer_description}}</th>
                </tr>
                 <tr>
                    <th>Copyright Description</th>
                </tr>
                <tr>
                    <th class="text">{{$id->copyright}}</th>
                </tr>

                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/add_footer_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
