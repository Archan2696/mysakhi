...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/searchpanes/2.2.0/css/searchPanes.dataTables.min.css" rel="stylesheet">
  ...
  <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               <a href=""><span>Expert Appointment Inquiry</span></a>
            </li>
         </ul>
      </div>
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Expert Appointment Inquiry</h4>

            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{ route('export-appointment') }}" style="color:white;">Export Data</a></button>
            </div>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_expert_appointment/'+id,
                                            type:'GET',
                                            dataType: "json",
