...
<style type="text/css">
    ...
    <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Media Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($media_description as $id) 
                <tr>
                    <th>Title1</th>
                </tr>
                <tr>
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_media_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            ...
            <div class="btn1-main">
                ...
                <button class="btn1"><a href="{{url('admin/add_media_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_media/'+id,
                                            type:'GET',
                                            dataType: "json",
