...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
 <div class="head-banner">
         <ul class="breadcrumb">
            ...
            <li>
               @if($id==0)
               <a href=""><span>Add Psychosocial Mood</span></a>
               @else
               <a href=""><span>Update Psychosocial Mood</span></a>
               @endif
            </li>
         </ul>
      </div>
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         <div class="list1">
           @if($id==0)
            <h4 class="mb-4">Add Psychosocial Mood</h4>
          @else
            <h4 class="mb-4">Update Psychosocial Mood</h4>
            @endif
         </div>
         <form action="{{url('admin/store_add_psychosocial_mood_data')}}/{{$id}}" method="post" enctype="multipart/form-data">
            @csrf
         <div class="detail table-responsive">
            <div class="details_main">
               ...
               @if(count($psychosocial_mood_list) == 0)
                    ...
                    <div class="feature-sections">
                    @foreach($psychosocial_mood_list as $key=>$f)
                    <div class="feature-section">
                        <div class="details_inner">
                            <div class="part">
                                <div class="row">
               ...
               <div class="uplode-btn" style="text-align: center;">
                  ...
                  <a href="{{url('admin/psychosocial_mood')}}">Back to Home?</a>
               </div>
            </div>
         </div>
