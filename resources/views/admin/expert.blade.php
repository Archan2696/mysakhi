...
<style type="text/css">
    ...
    <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Expert Description</h4>
         ...
         <div class="pro-table table-responsive">
            <table class="table table-bordered table-striped text">
                ...
                @foreach($expert_description as $id)
                ...
                <tr>
                    <th><button class="clo btn0"><a href="{{url('admin/update_expert_description_data')}}/{{$id->id}}">update</a></button></th>
                </tr>
    ...
    <div class="page mt-4 hosting-page title1" style="display: block;">
         <div class="list1">
            <h4 class="mb-0">Expert</h4>

            
            <div class="btn1-main">
                <!-- <button class="btn1 delete-btn1">all delete</button> -->
                <button class="btn1"><a href="{{url('admin/add_expert_data')}}/0" style="color:white;">ADD</a></button>
            </div>
         </div>
         <div class="sear-list">
            <div class="row">
               ...
               @foreach($expert as $key=>$ad)
                 <tbody class="change_visibility_{{$ad->id}}">
                    <tr>
                       ...
                       <td>{{$ad->name}}</td>
                       <td>
                        @php $expertise=experties_data($ad->id);@endphp
                        @if($expertise != '')
                       ...
                       <td>{!!$ad->description!!}</td>
                        ...
                        <td>
                        <a class="icon__1" href="{{url('admin/add_social_url_data')}}/{{$ad->id}}"><i class="fas fa-link"></i></a>

                          <a class="icon__1" href="{{url('admin/add_expert_data')}}/{{$ad->id}}"><i class="fas fa-edit"></i></a>
                               ...
                               var BASE_URL = "{{ url('/') }}";
                                ...
                                var id = $id;
                                      ...
                                      $.ajax({
                                            ...
                                            url:BASE_URL+'/admin/delete_expert/'+id,
                                            type:'GET',
                                            dataType: "json",
